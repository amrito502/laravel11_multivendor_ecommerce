                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('artical.update', $artical->id) }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input type="text" value="{{ old('title',$artical->title) }}" name="title" placeholder="Enter title" class="w-1/2 border-gray-300 rounded-lg shadow-sm">
                                @error('title')
                            ...
                            <div class="my-3">
                                <textarea name="text" placeholder="content" id="text" class="w-1/2 border-gray-300 rounded-lg shadow-sm">{{ $artical->text }}</textarea>
                                @error('text')
                                    <p class="font-medium text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="my-3">
                                <input type="text" value="{{ old('author',$artical->author) }}" name="author" placeholder="Enter author" class="w-1/2 border-gray-300 rounded-lg shadow-sm">
                                @error('author')
                                    <p class="font-medium text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
